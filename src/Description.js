...
const Description = () => {
  ...
  const partOne = "My name is Jao, a web application developer specialized in developing custom solutions using low-code and no-code platforms like Bubble, Xano...";

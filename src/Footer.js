...
const Footer = () => {
    return (
        <div className="footer">
            ...
            <div className="footer-icon-email" style={{ textAlign: 'left', fontSize: '20px', paddingLeft: '10px', whiteSpace: 'nowrap'}}><i className="fas fa-envelope" style={{ paddingRight: '10px' }}></i>contact@websolutions-consultant.com</div>
